        ...
        <div class="main-content">
          ...
          <p>{{ article.title }}...</p>
            ...
            <div class="right-sidebar">
                ...
                <div v-for="like in likes" class="article-ranking">
...
export default {
    ...
    async getLike() {
      this.loading = true;
      try {
        const response = await axios.get('/api/articleLikes/selectLikedArticlesOfUser', {
          params: {
            userId:101,
          }
        });
        // extend the articles array
        this.likes = [...this.likes, ...response.data];
      } catch (error) {
        console.error('请求失败:', error);
      } finally {
        this.loading = false;
